...
const token = '5438803575:AAHc1fUN8FBo0hgH97mAnhyO_DI0AYwSdJU';
const webAppUrl = "https://sparkly-pixie-84c4bc.netlify.app/"
...
bot.on('message', async (msg) => {
    ...
    if (msg?.web_app_data?.data) {
        try {
            ...
            await bot.sendMessage(chatId, 'Спасибо за вашу обратную свзяь!');
